...
app.post('/user/add', (req, res) => {
    ...
    if (userData.mobile == null || userData.email == null || userData.username == null || userData.password == null) {
...
const saveUserData = (data) => {
    ...
    fs.writeFileSync('./Details/users.json', stringifyData)

}

//get the user data from json file
const getUserData = () => {
    const jsonData = fs.readFileSync('./Details/users.json')
